...
#' \item `rmsd` `data.frame` com os itens que paresentaram DIF pelo método RMSD, com o nome do item e os valores de RMSD para cada categoria de resposta
#' }
#'
