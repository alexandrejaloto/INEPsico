#' @title INEPsico: Bora Facilitar a Vida
#'
#' @description Automatização de rotinas para análises psicométricas
#'
#' @author Alexandre Jaloto <alexandre.jaloto@inep.gov.br>
#' @details Este pacote tem como objetivo automatizar algumas rotinas de análise de
